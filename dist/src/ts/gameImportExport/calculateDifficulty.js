...
exports.calculateDifficulty = void 0;
/* Imports ---- */
const getPuzzleInfo_1 = require("../puzzleInfo/getPuzzleInfo");
/* ---- End */
...
const calculateDifficulty = (puzzleSolution) => {
    let difficulty = (0, getPuzzleInfo_1.getShortestDimension)(puzzleSolution);
    const puzzleSolutionByColumn = (0, getPuzzleInfo_1.getPuzzleByColumn)(puzzleSolution);
...
const getEmptyLineCount = (puzzleSolution) => {
    let count = 0;
...
const getFullLineCount = (puzzleSolution) => {
    let count = 0;
    for (let i = 0; i < puzzleSolution.length; i++) {
        const line = puzzleSolution[i];
...
const getSingleSolutionLineCount = (puzzleSolution) => {
    let count = 0;
    const isSingleSolutionLine = (line) => {
